  ...
  return (
    <div className="relative w-full bg-[url('https://png.pngtree.com/thumb_back/fh260/background/20240715/pngtree-morning-coffee-with-beans-and-steam-image_16013137.jpg')] bg-no-repeat bg-cover py-[50px] h-[660px] ">
      ...
      <section className="w-[50%] mx-auto mt-[150px]">
        ...
        />
        <p className="text-white  text-center mt-[30px] text-xl ">
          At Brew Coffee, we source only the finest beans and roast them with
          passion and precision. But our story isn't just about coffee — it's
          about people. Our café is a space where creativity brews, friendships
          grow, and community thrives.{" "}
        </p>
      </section>
    </div>
  );
